...
class VillagePopulationState {
    ...
    static async markVillageAsNew(villageId) {
        ...
        try {
            ...
            console.warn('[VillagePopulationState] markVillageAsNew failed:', (err as Error).message);
            return false;
        }
    }
    ...
    static async getPendingInserts() {
        ...
        try {
            ...
            console.warn('[VillagePopulationState] getPendingInserts failed:', (err as Error).message);
            return [];
        }
    }
    ...
    static async clearPendingOperations() {
        ...
        try {
            ...
            console.warn('[VillagePopulationState] clearPendingOperations failed:', (err as Error).message);
        }
    }
    ...
    static async reassignIds(mappings) {
        ...
        try {
            ...
            console.warn('[VillagePopulationState] reassignIds failed:', (err as Error).message);
        }
    }
}

export default VillagePopulationState;
