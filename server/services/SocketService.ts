...
class SocketService {
    ...
    emit(eventName, data) {
        ...
        try {
            ...
            logError(error as Error, `SocketService:Emit:${eventName}`, ErrorSeverity.MEDIUM);
        }
    }
    ...
    emitToRoom(room, eventName, data) {
        ...
        try {
            ...
            logError(error as Error, `SocketService:EmitToRoom:${room}:${eventName}`, ErrorSeverity.MEDIUM);
        }
    }
