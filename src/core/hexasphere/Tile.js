 ...
 * @param {Vector3D} p1 - First point
 * @param {Vector3D} p2 - Second point
 * @returns {Vector3D} Vector from p1 to p2
 */
 ...
 * @param {Vector3D} p1 - First point
 * @param {Vector3D} p2 - Second point
 * @param {Vector3D} p3 - Third point
 * @returns {Vector3D} Surface normal vector
 */
 ...
 * @param {Vector3D} p - Point
 * @param {Vector3D} v - Vector
 * @returns {boolean} True if pointing away from origin
 */
...
/**
 * Normalize a vector
 * @param {Vector3D} v - Vector to normalize
...
/**
 * Tile constructor
 * @param {Point} centerPoint - Center point of the tile
 * @param {number} [hexSize=1] - Size of hexagon (0.01 to 1.0)
 */
