...
// This script drops the 'families' and 'people' tables and removes their migration records.
...
async function resetSchema() {
    ...
    try {
        ...
        await client.query(`DELETE FROM schema_migrations WHERE version = '002_create_families_table.sql'`);
